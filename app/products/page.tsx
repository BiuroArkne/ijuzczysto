    ...
    return (
        <>
            ...
            <section className="container mx-auto px-4 mt-10 lg:mt-20">
                ...
                <h3 className="font-bold text-[#161819] text-3xl mt-6">Proszki do prania</h3>
            </section>

            <section className="container mx-auto px-4 mt-10 lg:mt-20 lg:flex gap-10">
                <div className="w-full lg:w-1/4 hidden lg:block">
                    <div className="border-[1px] border-[#E5E8E9] rounded-2xl p-6">
                        <p className="text-[#161819] font-bold text-lg">Filtry</p>

                        <div className="mt-6">
                            <p className="text-[#485053] font-bold">Cena</p>

                            <div className="flex items-center justify-center w-fit gap-2 mt-2">
                                <input className="border-[1px] w-1/2 outline-none focus:border-[#30B7F3] focus:text-[#30B7F3] hover:bg-[#E5E8E9] hover:text-[#6E797D] border-[#CBD0D3] font-semibold text-[#6E797D] rounded-lg px-4 py-2" type="text" placeholder="Od" />
                                    <span className="text-[#6E797D] text-sm">
                                        -
                                    </span>
                                <input className="border-[1px] w-1/2 outline-none focus:border-[#30B7F3] focus:text-[#30B7F3] hover:bg-[#E5E8E9] hover:text-[#6E797D] border-[#CBD0D3] font-semibold text-[#6E797D] rounded-lg px-4 py-2" type="text" placeholder="Od" />
                            </div>
                        ...
                        <div className="mt-6">
                            <p className="text-[#485053] font-bold">Nazwa</p>

                            <div className="mt-2">
                                <input className="border-[1px] w-full outline-none focus:border-[#30B7F3] focus:text-[#30B7F3] hover:bg-[#E5E8E9] hover:text-[#6E797D] border-[#CBD0D3] font-semibold text-[#6E797D] rounded-lg px-4 py-2" type="text" placeholder="Nazwa" />
                            </div>
                        </div>

                        <div className="mt-6">
                            <p className="text-[#485053] font-bold">Producent</p>

                            <div className="mt-2">
                                <input className="border-[1px] w-full outline-none focus:border-[#30B7F3] focus:text-[#30B7F3] hover:bg-[#E5E8E9] hover:text-[#6E797D] border-[#CBD0D3] font-semibold text-[#6E797D] rounded-lg px-4 py-2" type="text" placeholder="Producent" />
                            </div>
                        </div>

                        <div className="mt-6">
                            <p className="text-[#485053] font-bold">Marka</p>

                            <div className="mt-2">
                                <input className="border-[1px] w-full outline-none focus:border-[#30B7F3] focus:text-[#30B7F3] hover:bg-[#E5E8E9] hover:text-[#6E797D] border-[#CBD0D3] font-semibold text-[#6E797D] rounded-lg px-4 py-2" type="text" placeholder="Marka" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full lg:w-3/4">
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-10 mb-10">
                        ...
                        <div className="group relative">
                            <div className="bg-[#F7F8F8] rounded-2xl h-[222px] flex items-center justify-center relative">
                                <img className="object-cover" src="./images/product5.png" alt="" />
                        ...
                        <div className="group relative">
                            <div className="bg-[#F7F8F8] rounded-2xl h-[222px] flex items-center justify-center relative">
                                <img className="object-cover" src="./images/product7.png" alt="" />
                        ...
                        <div className="group relative">
                            <div className="bg-[#F7F8F8] rounded-2xl h-[222px] flex items-center justify-center relative">
                                <img className="object-cover" src="./images/product6.png" alt="" />
                        ...
                        <div className="group relative">
                            <div className="bg-[#F7F8F8] rounded-2xl h-[222px] flex items-center justify-center relative">
                                <img className="object-cover" src="./images/product8.png" alt="" />
                        ...
                        <div className="group relative">
                            <div className="bg-[#F7F8F8] rounded-2xl h-[222px] flex items-center justify-center relative">
                                <img className="object-cover" src="./images/product9.png" alt="" />
                        ...
                        <div className="group relative">
                            <div className="bg-[#F7F8F8] rounded-2xl h-[222px] flex items-center justify-center relative">
                                <img className="object-cover" src="./images/product10.png" alt="" />
                        ...
                        <div className="group relative">
                            <div className="bg-[#F7F8F8] rounded-2xl h-[222px] flex items-center justify-center relative">
                                <img className="object-cover" src="./images/product11.png" alt="" />
                        ...
                        <div className="group relative">
                            <div className="bg-[#F7F8F8] rounded-2xl h-[222px] flex items-center justify-center relative">
                                <img className="object-cover" src="./images/product12.png" alt="" />
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6 justify-between w-full mb-20">
                        <div>
                            <p className="text-[#6E797D] text-sm font-semibold">1 - 5 z 200 wyników</p>
                        </div>

                        <ul className="flex flex-row items-center justify-center gap-1">
                            <li>
                                <a className="w-10 h-10 flex justify-center items-center rounded-lg font-semibold bg-white stroke-[#6E797D] hover:bg-[#E5E8E9] hover:stroke-[#485053] mr-2" href="" title="">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g id="chevron-left">
                                            <path id="icon" d="M11.25 3.75L6.70711 8.29289C6.31658 8.68342 6.31658 9.31658 6.70711 9.70711L11.25 14.25" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                        </g>
                                    </svg>
                                </a>
                            </li>
                            ...
                            <li>
                                <a className="w-10 h-10 flex justify-center items-center rounded-lg font-semibold bg-white text-[#6E797D] hover:bg-[#E5E8E9] hover:text-[#485053]" href="" title="">
                                    1
                                </a>
                            </li>
                            ...
                            <li>
                                <a className="w-10 h-10 flex justify-center items-center rounded-lg font-semibold bg-white stroke-[#6E797D] hover:bg-[#E5E8E9] hover:stroke-[#485053] ml-2" href="" title="">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g id="chevron-right">
                                            <path id="icon" d="M6.75 3.75L11.2929 8.29289C11.6834 8.68342 11.6834 9.31658 11.2929 9.70711L6.75 14.25" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                        </g>
                                    </svg>
                                </a>
                            </li>
                        ...
                        <div>
                            <p className="text-[#6E797D] text-sm font-semibold">5 wyników</p>
                        </div>
                    </div>
                </div>
            </section>
